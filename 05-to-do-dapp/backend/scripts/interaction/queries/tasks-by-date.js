...
async function main() {
    ...
    const tasksOn2606 = await toDoContract.getTasksByDate(29062025);
    const tasksOn2706 = await toDoContract.getTasksByDate(30062025);
    console.log("\nTasks on 28-06-2025:", tasksOn2606.length);
